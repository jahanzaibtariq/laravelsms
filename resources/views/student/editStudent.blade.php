...
<div class="row">
	...
	<div class="col-lg-12" style="text-align: center;">
		<h3 class="page-header"><i class="fa fa-file-text-o"></i>Update Student Record </h3>
	...
	<div class="col-lg-12">
		<div class="panel panel-default" >
			...
			<div class="panel-body" style="padding-bottom: 4px">
				<form action="/updateStudent/{{$d->id}}" method="post" id="form-create-student" enctype="multipart/form-data">
						...
						<div class="col-lg-9 col-md-9 col-sm-9">
							...
							<div class="col-md-4">
								<div class="form-group" >
									...
									<input type="number" name="nationalcard" id="nationnal_card"   value="{{$d->nationalcard}}" class="form-control" required>
								</div>
							</div>
							{{-------Father Name------}}
							<div class="col-md-4">
								<div class="form-group" >
									...
									<input type="text" name="fathername" id="nationality" class="form-control"  value="{{$d->fathername}}" required>
							</div>
							...
							<div class="col-md-4">
								<div class="form-group" >
									...
									<input type="text" name="occupation" id="phone" class="form-control" value="{{$d->occupation}}" required>
								</div>
							</div>
						</div>
						{{--------------------------------}}
					...
					<div class="row">
						<div class="col-md-3">
							<div class="form-group" >
								...
								<input type="number" name="roll_no" id="village" class="form-control" value="{{$d->roll_no}}" required>
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group" >
						...
						<div class="col-md-3">
							<div class="form-group" >
								...
								<select style="margin-top: 0%;height:35px;" name="section" required>
									  <option>A</option>
									  <option>B</option>
									  <option>C</option>
								</select>
						...
						<div class="col-md-3">
							<div class="form-group" >
								...
								<input type="date" name="addmission_date" id="district" class="form-control" value="{{$d->addmission_date}}" required>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="panel-footer">
					<button  class="btn btn-default btn-save">Update Student <i class="fa fa-save"></i></button>
				</div>
			</form>
		</div></div></div></div>
@endsection
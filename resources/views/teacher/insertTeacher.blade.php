...
<div class="row">
	...
	<div class="col-lg-12" style="text-align: center;">
		<h3 class="page-header"><i class="fa fa-file-text-o"></i> Teacher Registration </h3>
	...
	<div class="col-lg-12">
		...
		<div class="panel panel-default" >
			...
			<div class="panel-body" style="padding-bottom: 4px">
				<form action="{{ url('/add-teacher') }}" method="POST" id="form-create-student" enctype="multipart/form-data">
						...
						<div class="col-lg-9 col-md-9 col-sm-9">
							...
							<div class="col-md-4">
								<div class="form-group" >
									...
									<input type="text" name="specialization" id="nationnal_card" class="form-control" required>
								</div>
							</div>
				...
				<div class="panel-footer">
					<button value="submit" class="btn btn-default btn-save">Add Teacher <i class="fa fa-save"></i></button>
				</div>
			</form>
		</div></div></div></div>
@endsection
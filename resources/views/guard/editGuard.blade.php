...
<div class="row">
	...
	<div class="col-lg-12" style="text-align: center;">
		<h3 class="page-header"><i class="fa fa-file-text-o"></i>Update Security_Guard Record </h3>
	...
	<div class="col-lg-12">
		<div class="panel panel-default" >
			...
			<div class="panel-body" style="padding-bottom: 4px">
				<form action="/updateGuard/{{$d->id}}" method="post" id="form-create-student" enctype="multipart/form-data">

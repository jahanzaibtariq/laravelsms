...
<div class="row">
	<div class="col-lg-12" style="text-align: center;">
		<h3 class="page-header"><i class="fa fa-file-text-o"></i> Security_Guard Registration </h3>
	</div>
</div>
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default" >
			<div class="panel-heading">
				<b><i class="fa fa-apple"></i> Security_Guard Information </b>
			</div>

			<div class="panel-body" style="padding-bottom: 4px">
				<form action="{{ url('/add-guard') }}" method="POST" id="form-create-student" enctype="multipart/form-data">
					<div class="row">
				...
				<div class="panel-footer">
					<button value="submit" class="btn btn-default btn-save">Add Guard <i class="fa fa-save"></i></button>
				</div>
			</form>
		</div></div></div></div>
@endsection